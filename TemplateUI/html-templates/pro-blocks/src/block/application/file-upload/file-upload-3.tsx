...
import { Trash1, UploadCloud, Xmark2x } from '@tailgrids/icons';
      ...
      <div className="bg-background-50 w-[500px] overflow-hidden rounded-2xl">
        ...
        <div className="border-base-100 flex items-center justify-between border-b p-5">
          <div className="flex gap-2.5">
            <div className="border-base-100 flex size-12 items-center justify-center rounded-full border">
              <UploadCloud className="text-text-50 size-6" />
            </div>
            <div>
