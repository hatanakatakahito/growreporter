          ...
          <div className="pointer-events-none absolute inset-x-0 top-1/2 hidden -translate-y-1/2 justify-center lg:flex">
            <div className="pointer-events-auto flex items-center space-x-1">
              ...
              >
                ...
                {/* Mega Menu Dropdown */}
                <div
                  className={`border-base-50 bg-background-50 absolute top-full left-0 z-50 w-screen max-w-[940px] rounded-xl border shadow-lg transition-all duration-200 ease-out ${
                    megaMenuOpen
                      ...
                      <div className="flex flex-col space-y-3">
                        {QUICK_LINKS.map((link) => (
                          <a
                            key={link}
                            href="javascript:void(0)"
                            className="hover:text-primary-500 text-text-200 text-base font-medium transition-colors"
                          >
                            {link}
                          </a>
                        ))}
