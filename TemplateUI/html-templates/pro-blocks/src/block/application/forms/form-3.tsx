        ...
        <div className="bg-background-50 rounded-2xl p-4 shadow-sm sm:p-12">
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 flex items-center">
              <div className="border-base-200 w-full border-t"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="bg-background-50 text-text-100 px-4">
          ...
          <form>
            ...
            {/* <!-- Login Link --> */}
            <p className="text-text-100 mt-4 text-left text-sm">
