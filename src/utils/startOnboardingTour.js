...
const STEP_TITLE = {
  ...
  analysisKeywords: '検索キーワード',
  analysisReferrals: '参照元サイト',
  analysisPages: 'ページ別',
  analysisContent: 'コンテンツ分析',
  analysisPageCategories: 'ページ分類別',
  analysisLandingPages: '入口ページ',
  analysisPageFlow: '次に見たページ',
  analysisConversions: 'コンバージョン',
  analysisReverseFlow: '成果までの到達ステップ',
  analysisExternalLinks: '外部リンククリック',
  analysisFileDownloads: '資料ダウンロード',
