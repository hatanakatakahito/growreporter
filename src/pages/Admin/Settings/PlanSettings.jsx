            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div>
                ...
                <input
                  ...
                  disabled={!canEdit}
                  className="w-full rounded-lg border border-stroke bg-white px-4 py-2 text-dark transition-all duration-200 focus:border-primary-mid focus:outline-none focus:ring-2 focus:ring-primary-mid/20 disabled:opacity-50 dark:border-dark-3 dark:bg-dark dark:text-white"
                />
              </div>
              <div>
                <label className="mb-2 block text-sm font-medium text-dark dark:text-white">
        ...
        {canEdit && (
          <div className="mt-6 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="flex items-center gap-2 rounded-lg bg-primary px-6 py-2 font-medium text-white transition hover:bg-opacity-90 disabled:opacity-50"
            >
