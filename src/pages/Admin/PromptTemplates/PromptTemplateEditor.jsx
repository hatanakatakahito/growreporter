      ...
      <div className="space-y-6 rounded-lg border border-stroke bg-white p-6 dark:border-dark-3 dark:bg-dark-2">
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-md border border-stroke bg-transparent px-4 py-3 text-dark outline-none transition-all duration-200 focus:border-primary-mid focus:ring-2 focus:ring-primary-mid/20 dark:border-dark-3 dark:text-white"
          >
            {pageTypes.map((type) => (
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-md border border-stroke bg-transparent px-4 py-3 font-mono text-sm text-dark outline-none transition-all duration-200 focus:border-primary-mid focus:ring-2 focus:ring-primary-mid/20 dark:border-dark-3 dark:text-white"
          />
        ...
        <div>
          <label className="flex items-center gap-2">
            <input
              ...
              onChange={handleChange}
              className="h-4 w-4 rounded border-stroke text-primary transition-all duration-200 focus:ring-2 focus:ring-primary-mid/20 dark:border-dark-3"
            />
