  ...
  return (
    <DashboardLayout>
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        {/* クイックアクション */}
        <div className="mb-6 analysis-card p-6">
          <h3 className="text-xl font-semibold text-dark dark:text-white mb-4">クイックアクション</h3>
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/site-settings?step=3"
              className="inline-flex items-center justify-center rounded-md border border-primary px-6 py-3 text-center font-medium text-primary hover:bg-primary hover:text-white lg:px-8 xl:px-10 transition-colors"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.96-.587 1.724-1.066 2.572-1.065z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
              KPI設定
            </Link>
            <button
              onClick={() => alert('レポートダウンロード機能は今後実装予定です。')}
              className="inline-flex items-center justify-center rounded-md border border-gray-300 px-6 py-3 text-center font-medium text-body-color hover:bg-gray-100 dark:border-dark-3 dark:text-dark-6 dark:hover:bg-dark-3 lg:px-6 xl:px-8 transition-colors"
            >
