...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('📊 GA4 イベント一覧取得開始:', { userId, propertyId, startDate, endDate });
    ...
    console.log(`✅ GA4 イベント一覧取得成功: ${events.length} 件`);
    ...
    console.error('❌ GA4 イベント一覧取得エラー (catch):', error);
