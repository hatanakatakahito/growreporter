...
export default function Step3SearchConsole({ onNext, onBack, initialData = {} }) {
  const [siteUrl, setSiteUrl] = useState(initialData.searchConsoleSiteUrl || '');
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // Search Console API のスコープを使用
      console.log('Initiating Search Console OAuth...');
      ...
      console.error('Search Console connection error:', err);
      setError('Search Consoleとの接続に失敗しました。もう一度お試しください。');
      setIsConnecting(false);
    }
  };
