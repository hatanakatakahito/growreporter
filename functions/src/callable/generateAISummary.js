...
- **今後3ヶ月の戦略として、具体的なアクションを1-3点提案**：
  - 成長トレンドを加速させる施策
  - 減少トレンドを反転させる施策
  - **タイトルは改善内容を簡潔に記載**（例：「ページ読み込み速度の改善」）
...
- **具体的なアクションを1-3点提案**：
  ...
  - **タイトルは改善内容を簡潔に記載**（例：「モバイルユーザー向けUI改善」）
  - 優先順位、ビジネスインパクト、具体的な方法は説明文で詳しく補足
...
- **トレンドの原因を考察**：「なぜそうなったか」の視点で記述
- **具体的なアクションを1-3点提案**：
  - **タイトルは改善内容を簡潔に記載**（例：「CTAボタンの配置見直し」）
