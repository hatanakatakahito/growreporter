...
export async function generateImprovementsCallable(req) {
  ...
  const { siteId, improvementFocus = 'balance', userNote = '', forceRegenerate = false, autoGenerated = false, triggeredBy = 'manual', startDate: reqStartDate, endDate: reqEndDate } = req.data;
