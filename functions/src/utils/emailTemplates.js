...
export function getBusinessUpsellHtml() {
  return `
    <div style="background: linear-gradient(135deg, #f87171 0%, #ec4899 100%); border-radius: 12px; padding: 24px; margin-top: 32px; text-align: center;">
      ...
      <a href="https://grow-reporter.com/plan-info" style="display: inline-block; background: white; color: #ec4899; font-weight: bold; padding: 10px 24px; border-radius: 8px; text-decoration: none; font-size: 14px;">ビジネスプランを詳しく見る</a>
    </div>`;
}
