...
function getAnalysisPerspectives(pageType, meta, metrics) {
  const perspectives = {
    ...
    summary: '- 期間全体のトレンドと変化点の分析\n- 月次推移から見る成長性\n- 季節性やイベントによる影響',
    users: '- 主要なターゲット顧客層の特定\n- デバイス・地域・年齢・性別の傾向分析\n- ペルソナに基づくコンテンツ最適化',
    day: '- 日次のトレンドとピーク日の特定\n- 異常値や急激な変化の要因分析\n- 定期的なパターンの発見',
    week: '- 曜日別のユーザー行動パターン\n- 平日と週末のパフォーマンス差\n- コンテンツ公開の最適タイミング',
    hour: '- 時間帯別のアクセスパターン\n- ピーク時間帯とオフピーク時間帯の特定\n- 広告配信やメール送信の最適タイミング',
    channels: '- 高ROIチャネルの特定\n- チャネル別のユーザー品質評価\n- マーケティング予算配分の最適化',
    keywords: '- 高パフォーマンスキーワードの特徴\n- CTRや順位から見る改善機会\n- 新規コンテンツのキーワード選定',
    referrals: '- 主要な参照元とトラフィック品質\n- パートナーシップの効果測定\n- 新規参照元の開拓機会',
    pages: '- 高エンゲージメントページの特徴\n- 低パフォーマンスページの課題\n- コンテンツの優先改善順位',
    pageCategories: '- カテゴリ別のユーザー関心度\n- サイト構造とナビゲーションの課題\n- カテゴリ再編の必要性',
    landingPages: '- 高CVRランディングページの特徴\n- 流入は多いが離脱が多いページ\n- 新規ユーザー獲得の改善ポイント',
    fileDownloads: '- 人気資料とユーザーニーズ\n- ダウンロード導線の最適化\n- リード獲得の改善機会',
    externalLinks: '- ユーザーの関心がある外部コンテンツ\n- アフィリエイトやパートナーシップの効果\n- 内部コンテンツ強化の機会',
    conversions: '- CVイベント別のパフォーマンス\n- CV数の推移とトレンド\n- CV最適化の優先順位',
    reverseFlow: '- CVに至る主要な行動パターン\n- ファネルのボトルネック\n- 離脱ポイントと改善機会',
  };
...
function getActionProposals(pageType, meta) {
  const proposals = {
    dashboard: '  - 最も改善効果の高いKPIの特定と施策提案\n  - クイックウィン（短期改善）とロングターム施策の提示\n  - 定期的にモニタリングすべき指標の提示',
    summary: '  - トレンドに基づく今後の施策方針\n  - 成長を加速させるための重点領域\n  - 季節性を考慮した計画立案',
    users: '  - ターゲット顧客層に最適化したコンテンツ改善\n  - デバイス・地域別の最適化施策\n  - 新規顧客層の開拓機会',
    day: '  - ピーク日を活用したキャンペーン施策\n  - 低パフォーマンス日の改善策\n  - 定期的なコンテンツ更新タイミング',
    week: '  - 曜日別のコンテンツ公開戦略\n  - 週末向け・平日向けコンテンツの最適化\n  - メールマガジンやSNS投稿の最適タイミング',
    hour: '  - ピーク時間帯に合わせた広告配信最適化\n  - リアルタイムサポートの人員配置調整\n  - プッシュ通知やメール配信のタイミング最適化',
    channels: '  - 高ROIチャネルへの予算シフト\n  - 低パフォーマンスチャネルの改善または撤退\n  - 新規チャネルの開拓機会',
    keywords: '  - タイトル・メタディスクリプションの改善\n  - コンテンツの追加・強化\n  - 新規コンテンツのキーワード選定',
    referrals: '  - 主要参照元との関係強化\n  - 新規パートナーシップの開拓\n  - 被リンク獲得施策の強化',
    pages: '  - 高パフォーマンスページの横展開\n  - 低パフォーマンスページの改善（コンテンツ・導線）\n  - 内部リンク構造の最適化',
    pageCategories: '  - 人気カテゴリへのアクセス導線強化\n  - カテゴリ再編とナビゲーション改善\n  - 低PVカテゴリのコンテンツ強化',
    landingPages: '  - 高CVRページへの流入増加施策\n  - 低CVRページの改善（ファーストビュー、CTA）\n  - 新規ランディングページの作成',
    fileDownloads: '  - 人気資料への導線強化\n  - 新規資料の企画・制作\n  - ダウンロード後のフォローアップ改善',
    externalLinks: '  - 人気外部リンクに関連する内部コンテンツ強化\n  - アフィリエイトリンクの最適配置\n  - パートナーコンテンツの拡充',
    conversions: '  - 高パフォーマンスCVイベントの強化\n  - 低パフォーマンスCVの改善施策\n  - マイクロコンバージョンの設定',
    reverseFlow: '  - CVに至る主要経路の強化\n  - ファネルのボトルネック解消\n  - 離脱ポイントの改善',
  };
